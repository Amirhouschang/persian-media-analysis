"""
Checks telegram_jan_aug_2026.csv (the main file (5 channels)) for completeness.
  python 00_check_telegram.py
Output: seven checks in the terminal + weekly table pruefung_beitraege_pro_woche.csv in data/row/
"""
